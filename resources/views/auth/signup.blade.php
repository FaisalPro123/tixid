...
<body>
    <form class="w-50 d-block mx-auto my-5" method="POST" action="{{ route('signup.register') }}">
        ...
        <div class="row mb-4">
            <div class="col">
                <div data-mdb-input-init class="form-outline">
                    <!-- name : memberikan identitas data agar data yg diinput bisa diakses controller, namanya snack case bahasa inggris -->
        ...
        <!-- Submit button -->
        <button data-mdb-input-init type="submit" class="btn btn-primary btn-block">SignUp</button> 
