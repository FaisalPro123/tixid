...
{{-- Auth::user()->field : mengambil data orang yg login, field dari fillable model user --}}
...
<div class="container my-3">
    ...
    <div class="d-flex my-3 gap-2">
        ...
        <a href="" class="btn btn-outline-primary rounded-pill" style="padding: 5px 10px"><small>Cinepolis</small></a>
    </div>
        </div>
...
<footer class="bg-body-tertiary text-center text-lg-start mt-5">
    <!-- copyright -->
    <div class="text-center p-3" style="background-color: rgba(0, 255, 251, 0.5);">
        © 2025 Copyright:
